  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/quiz/submit-quiz/",
        { answers: answers }
      );
              ...
              <div>
                {answer.question === "Genre Preference" && (
                  <>
                    <input
                      ...
                      onChange={() =>
                        handleAnswerChange(index, "Action, Adventure")
                      }
                    />
                    ...
                    <input
                      ...
                      onChange={() =>
                        handleAnswerChange(index, "Romance, Drama")
                      }
                    />
                    <label htmlFor={`optionB-${index}`}>B) Romance/Drama</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionC-${index}`}
                    ...
                    />
                    <label htmlFor={`optionC-${index}`}>C) Comedy</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionD-${index}`}
                      ...
                      onChange={() =>
                        handleAnswerChange(index, "Sci-fi, Fantasy")
                      }
                    />
                    <label htmlFor={`option-${index}`}>D) Sci-fi/Fantasy</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionE-${index}`}
                      ...
                      onChange={() =>
                        handleAnswerChange(index, "Horror, Thriller")
                      }
                    />
                    <label htmlFor={`optionE-${index}`}>
                      E) Horror/Thriller
                    </label>
                    <br />
                  </>
                ...
                {answer.question === "Mood" && (
                  <>
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>A) Excited</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionB-${index}`}
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>B) Romantic</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionC-${index}`}
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>C) Laughing</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionD-${index}`}
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>D) Wondering</label>
                    <br />
                    <input
                      type="radio"
                      id={`optionE-${index}`}
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>E) Thrilled</label>
                    <br />
                  </>
                )}
                {answer.question === "Main Characters" && (
                  <>
                    <input
                      ...
                      checked={
                        answer.selectedAnswer === "Strong, heroic figures"
                      }
                      onChange={() =>
                        handleAnswerChange(index, "Strong, heroic figures")
                      }
                    />
                    <label htmlFor={`optionA-${index}`}>
                      A) Strong, heroic figures
                    </label>
                    <br />
                    <input
                      type="radio"
                      ...
                      checked={
                        ...
                        "Complex, emotionally-driven characters"
                      }
                      onChange={() =>
                        handleAnswerChange(
                          index,
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>
                      B) Complex, emotionally-driven characters
                    </label>
                    <br />
                    <input
                      type="radio"
                      ...
                      checked={
                        answer.selectedAnswer ===
                        "Quirky and funny personalities"
                      }
                      onChange={() =>
                        handleAnswerChange(
                          index,
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>
                      C) Quirky and funny personalities
                    </label>
                    <br />
                    <input
                      type="radio"
                      ...
                      checked={
                        answer.selectedAnswer ===
                        "Intellectual and imaginative individuals"
                      }
                      onChange={() =>
                        handleAnswerChange(
                          index,
                    ...
                    />
                    <label htmlFor={`optionA-${index}`}>
                      D) Intellectual and imaginative individuals
                    </label>
                    <br />
                    <input
                      type="radio"
                      ...
                      checked={
                        answer.selectedAnswer === "Underdog or survivor types"
                      }
                      onChange={() =>
                        handleAnswerChange(index, "Underdog or survivor types")
                      }
                    />
                    <label htmlFor={`optionA-${index}`}>
                      E) Underdog or survivor types
                    </label>
                    <br />
                  </>
                )}
