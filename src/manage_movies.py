...
def help():
    print("\nUsage:")
    print("  python manage_movies.py populate  - Fetch movies from TMDB API and populate the database")
    print("  python manage_movies.py count     - Count movies in the database")
    print("  python manage_movies.py clear     - Clear all movies from the database")
    print("  python manage_movies.py help      - Show this help message\n")
...
def clear_movies():
    ...
    print(f"\nDeleted {count} movies from the database")
...
if __name__ == "__main__":
    ...
    if command == 'populate':
        print("\nStarting movie fetch process...")
        fetch_and_populate_movies()
        print("\nMovie fetch process completed!")
    elif command == 'count':
        count_movies()
    elif command == 'clear':
        clear_movies()
